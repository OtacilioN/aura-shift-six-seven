# MUS-NEON-DRIFT-67 — proveniência da trilha selecionada

- **Título:** Neon Drift 67
...
- **Fonte preservada:** `sources/audio/imported/chatgpt-2026-07-12/01_neon_drift_67.wav`
- **SHA-256 da fonte:** `cf22770c88ce4c82516026cae5e536262a5169aeb7dd1e4f3b5f3394c3e0f12e`
- **Fonte:** `44100 Hz`, `PCM_24`, `2` canais, `25.6` s.
- **Métricas da fonte:** `-9.5162` LUFS-I, `-0.7242` dBFS peak, `-0.1078` dBTP.
- **Processamento:** resample polifásico `160/147` para `48000 Hz`, ganho de `-6.4828` dB até `-16 LUFS-I`; sem compressor ou limiter.
- **Master derivado:** `masters/audio/mus_neon_drift_67.wav` — `2fd36a8c38d46170259eff234f8adaf04892d9eb59177e7ea443fa7c5955f31f`
- **Runtime Android:** `assets/audio/music/mus_neon_drift_67.ogg` — `81ca09bce25628a859a60499d2bbb1e6e7f1babf8737f5feef27786450560739`
- **Runtime:** Ogg/Vorbis q6, `48000 Hz`, `2` canais, `25.6` s, `-15.9996` LUFS-I, `-6.4665` dBTP.
