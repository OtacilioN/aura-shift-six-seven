...
Entradas normativas: `PLANNING-TO-DEVELOPMENT-ROADMAP.md`, `REQUIREMENTS.md`, `MVP-SCOPE.md`, `CONTEXT.md`, contratos econômicos `balance-v0.2`/`arith-v1`/`number-format-v1` e todos os artefatos listados abaixo.
...
6. **Economia:** `balance-v0.2` substituiu o baseline anterior e continua candidato até passar por `balance-gate-v1`; esse gate não pertence às rodadas criativas P01–P11.
