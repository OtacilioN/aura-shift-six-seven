...
| `ITEM-A-03` | **QA Goggles** | `Reveal three bugs. Two will be promoted to mechanics.` | óculos escuros angulares e envolventes, com duas lentes opacas, ponte e hastes neon, vestidos sobre os olhos | reflexos diagonais, duas marcas aprovadas, glow inferior reduzível, contorno extra | preservar a leitura da expressão corporal, alternativa sem flash e transcriação de `QA`; baixo |
