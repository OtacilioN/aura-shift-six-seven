...
- Mascote Canvas procedural, mãos Six/Seven e cinco expressões;
...
- cena Flame com fundo, Mascote Canvas, todas as skins ativas, Forma e VFX reais;
...
- latência, loop por menu/shuffle/crossfade, foco/retomada e fadiga;
...
# Os dois comandos abaixo são somente reprodução histórica e recriam as nove
# músicas v1 removidas; não os execute para montar o pacote atual.
...
- masters WAV PCM 48 kHz/24-bit, música runtime Ogg 48 kHz e SFX runtime WAV
  PCM16 48 kHz;
- sete músicas completas sem markers de loop, frame count preservado no Ogg e ordem sorteável no runtime;
...
- escolha inicial, loop estável, troca por menu, shuffle 7/7, crossfade e ausência de avanço por conclusão avaliados no runtime;
